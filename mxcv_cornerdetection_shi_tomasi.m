function corner_detected_image = mxcv_cornerdetection_shi_tomasi (input_image,...
                                                                  threshold_value,...
                                                                  window_width)
% corner_detected_image = mxcv_cornerdetection_shi_tomasi (input_image,...
%                                                          threshold_value,...
%                                                          window_width)
...
if isa (input_image, 'double') && ndims (input_image) == 2
    if window_width > 0
        ...
        disp ('----------------------------------------------------------------------------')
        disp ('Error: In function mxcv_cornerdetection_shi_tomasi')
