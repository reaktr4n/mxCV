function corner_detected_image = mxcv_cornerdetection_harris (input_image,...
                                                              alpha_value,...
                                                              threshold_value,...
                                                              window_width)
% corner_detected_image = mxcv_cornerdetection_harris (input_image,...
%                                                      alpha_value,...
%                                                      threshold_value,...
%                                                      window_width)                                                        
    ...
    if window_width > 0 && alpha_value > 0
        ...
        for i=1:image_rows
            for j=1:image_cols
                ...
                % TODO 21
                r_value = determinant_value+(alpha_value*(trace_value*trace_value));
        ...
        disp ('----------------------------------------------------------------------------')
        disp ('Error: In function mxcv_cornerdetection_harris')
